...
--   my_picker_mru({ only_cwd = true, attach_mappings = mr_custom_action })
-- end)
-- nmap("<Space>F", function()
--   my_picker_mru({ attach_mappings = mr_custom_action })
-- end)
--
-- nmap("<Space>R", function()
--   telescope_builtin.resume()
-- end)
-- nmap("<Leader><Leader>g", function()
--   telescope_builtin.live_grep()
-- end)
-- nmap("<Leader><Leader>f", function()
--   telescope_builtin.fd({ cwd = vim.fn.expand("%:p:h") })
-- end)
-- nmap("<Leader><Leader>F", function()
--   telescope_builtin.fd({ find_command = { "fd", "--type", "f" } })
-- end)
--
...
--         local win_length = vim.fn.winwidth(windowid)
...
--         end
--
--         local padding = string.rep(" ", (vim.fn.winwidth(windowid) - (left_char_padding + right_char_padding + #char)) / 2)
--
--         return string.format(
--           "%%#Normal#%s%%#%s#%s%s%s%%#Normal#%%=",
--           padding,
...
--       end,
--       ["zz"] = function(state)
--         fn.setreg(vim.v.register, vim.inspect(state.tree))
--       end,
--       ["Zz"] = function(state)
--         fn.setreg(vim.v.register, vim.inspect(state))
--       end,
--       ["<C-y>"] = function(state)
--         My.echo_and_yank(state.tree:get_node().path)
--       end,
--       ["t"] = function(state)
...
--
-- -- nvim-cmp setup
-- vim.g.vsnip_snippet_dir = fn.stdpath("data") .. "/friendly-snippets/snippets"
...
-- nvim_lspconfig.tsserver.setup({ on_attach = on_attach })
...
-- imap("<S-CR>", function()
--   return "<End>" .. call("lexima#expand", "<LT>CR>", "i")
...
--   print(fn.substitute(vim.opt.runtimepath._value, ",", "\n", "g"))
-- end, {})
...
-- end)
-- nxmap("S", function()
--   require("leap").leap({ target_windows = { fn.win_getid() } })
-- end)
--
...
--
-- imap("<C-s>", function()
--   return call("vsnip#expandable") and "<Plug>(vsnip-expand)" or "<C-s>"
-- end, { expr = true })
-- smap("<C-s>", function()
--   return call("vsnip#expandable") and "<Plug>(vsnip-expand)" or "<C-s>"
-- end, { expr = true })
--
-- imap("<C-k>", function()
--   return call("vsnip#available") and "<Plug>(vsnip-expand-or-jump)" or "<C-k>"
-- end, { expr = true })
-- smap("<C-k>", function()
--   return call("vsnip#available") and "<Plug>(vsnip-expand-or-jump)" or "<C-k>"
-- end, { expr = true })
...
--
-- nmap("dk", function()
--   return fn.line(".") == fn.line("$") and "dk" or "dkk"
-- end, { expr = true })
--
